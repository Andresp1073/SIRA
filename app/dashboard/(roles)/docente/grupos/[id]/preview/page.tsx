        ...
        <div className="p-6 bg-white dark:bg-slate-900">
          <div className="bg-slate-50 dark:bg-slate-800/40 p-5 grid grid-cols-1 sm:grid-cols-2 gap-x-12 gap-y-4 text-xs border border-slate-200 dark:border-slate-800 rounded-xl">
            <div className="flex flex-col gap-1">
              ...
              <span className="sm:text-sm text-xs font-semibold text-slate-900 dark:text-slate-100 uppercase">
                {teacherName}
              </span>
            </div>
            <div className="flex flex-col gap-1">
              ...
              <span className="sm:text-sm text-xs font-semibold text-slate-900 dark:text-slate-100">
                {subject.program ?? 'N/A'}
              </span>
            </div>
            <div className="flex flex-col gap-1">
            ...
            <div className="flex flex-col gap-1 flex-wrap">
              <div className="grid grid-cols-3 w-full gap-4">
                ...
                <div className="flex flex-col gap-1">
                  ...
                  <span className="sm:text-sm text-xs font-semibold text-slate-900 dark:text-slate-100 tracking-card">
                    {currentPeriod}
                  </span>
                </div>
              </div>
