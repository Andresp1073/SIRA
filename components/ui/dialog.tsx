  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      onPointerDownOutside={e => {
        ...
        const isInCalendar = target.closest('[data-slot="calendar"]');
        const isDayButton = target.closest('button[data-day]');

        if (isInPopover || isInCalendar || isDayButton) {
          e.preventDefault();
        }
      }}
      onInteractOutside={e => {
